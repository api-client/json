...
import _equal from '../../src/core/Equal.js';

const equal = (a: any, b: any): void => {
  assert.strictEqual(_equal(a, b), true);
};

const differ = (a: any, b: any): void => {
  assert.strictEqual(_equal(a, b), false);
};
